...
Oracle-AI-Auto = fallback,policy-regex-filter=Oracle|oracle|San Jose|SanJose|圣何塞,AI-JP-SG-Auto,url=https://www.gstatic.com/generate_204,interval=300,timeout=8
...
# AI and Google search homepage: Oracle-labelled node first, Japan/Singapore fallback only.
...
RULE-SET,https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Claude/Claude.list,Oracle-AI-Auto
RULE-SET,https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Shadowrocket/Gemini/Gemini.list,Oracle-AI-Auto
DOMAIN-SUFFIX,google.com,Oracle-AI-Auto
DOMAIN-SUFFIX,google.com.hk,Oracle-AI-Auto
DOMAIN-SUFFIX,googleapis.com,Oracle-AI-Auto
DOMAIN-SUFFIX,gstatic.com,Oracle-AI-Auto
DOMAIN-SUFFIX,googleusercontent.com,Oracle-AI-Auto
DOMAIN-SUFFIX,google.ai,Oracle-AI-Auto
# END local routing patch
